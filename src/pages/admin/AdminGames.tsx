      ...
      <div className="p-4 md:p-8">
        <div className="mb-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <h1 className="text-2xl  font-bold" style={{ color: "hsl(var(--brown-deep))", fontFamily: "Electrolize, sans-serif" }}>Games</h1>
              <p className="text-sm mt-1" style={{ color: "hsl(var(--brown-light))" }}>{games.length} configured</p>
            </div>
            <button onClick={openCreate} className="flex items-center gap-2 px-3 md:px-4 py-2.5 rounded-xl  text-xs md:text-sm tracking-wider" style={{ background: "linear-gradient(135deg, hsl(var(--brown)), hsl(var(--brown-light)))", color: "hsl(var(--cream))", fontFamily: "Electrolize, sans-serif" }}>
          ...
          <div className="w-full max-w-2xl rounded-2xl overflow-hidden" style={{ background: "hsl(var(--card))", border: "1px solid hsl(var(--cream-dark))" }}>
            <div className="max-h-[90dvh] overflow-y-auto overflow-x-hidden animated-scroll-area no-scrollbar">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs  tracking-widest mb-1.5" style={{ color: "hsl(var(--brown))", fontFamily: "Electrolize, sans-serif" }}>GAME ID</label>
              ...
              <div>
                <div>
                  <label className="block text-xs  tracking-widest mb-1.5" style={{ color: "hsl(var(--brown))", fontFamily: "Electrolize, sans-serif" }}>DATE & TIME</label>
                  <Popover>
              ...
              <div>
                <label className="block text-xs  tracking-widest mb-1.5" style={{ color: "hsl(var(--brown))", fontFamily: "Electrolize, sans-serif" }}>RULES</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs  tracking-widest mb-1.5" style={{ color: "hsl(var(--brown))", fontFamily: "Electrolize, sans-serif" }}>GAME IMAGE</label>
                ...
                <div>
                  <label className="block text-xs  tracking-widest mb-1.5" style={{ color: "hsl(var(--brown))", fontFamily: "Electrolize, sans-serif" }}>BG VIDEO</label>
              ...
              {/* Status toggle */}
              <div>
                <label className="block text-xs  tracking-widest mb-2" style={{ color: "hsl(var(--brown))", fontFamily: "Electrolize, sans-serif" }}>STATUS</label>
                <button
              ...
              {form.status === "completed" && (
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="text-xs  tracking-widest" style={{ color: "hsl(var(--brown))", fontFamily: "Electrolize, sans-serif" }}>GAME RANKINGS</label>
                    {rankings.length < 10 && (
                      <button onClick={() => setRankings((r) => [...r, { rank: r.length + 1, player_id: "", points: 0 }])} className="text-xs " style={{ color: "hsl(var(--brown-light))", fontFamily: "Electrolize, sans-serif" }}>+ Add</button>
                    )}
                  </div>
                ...
                <button onClick={saveGame} disabled={saving} className="w-full py-3 rounded-xl  text-sm tracking-widest flex items-center justify-center gap-2" style={{ background: "linear-gradient(135deg, hsl(var(--brown)), hsl(var(--brown-light)))", color: "hsl(var(--cream))", fontFamily: "Electrolize, sans-serif" }}>
      ...
      {confirmDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "hsla(var(--brown-deep) / 0.5)", backdropFilter: "blur(8px)" }}>
          <div className="rounded-2xl p-8 max-w-sm w-full text-center" style={{ background: "hsl(var(--card))" }}>
            ...
            <h3 className=" font-bold text-lg mb-2" style={{ color: "hsl(var(--brown-deep))", fontFamily: "Electrolize, sans-serif" }}>Delete Game?</h3>
