      ...
      <div className="p-4 md:p-8">
        <div className="md:sticky md:top-0 z-20 mb-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <button onClick={openCreate} className="flex items-center gap-2 px-3 md:px-4 py-2.5 rounded-xl font-cinzel text-xs md:text-sm tracking-wider" style={{ background: "linear-gradient(135deg, hsl(var(--brown)), hsl(var(--brown-light)))", color: "hsl(var(--cream))", fontFamily: "'ROWAN', serif" }}>
          ...
          <div className="w-full max-w-2xl rounded-2xl overflow-hidden" style={{ background: "hsl(var(--card))", border: "1px solid hsl(var(--cream-dark))" }}>
            <div className="max-h-[90dvh] overflow-y-auto overflow-x-hidden animated-scroll-area no-scrollbar">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-cinzel tracking-widest mb-1.5" style={{ color: "hsl(var(--brown))", fontFamily: "'ROWAN', serif" }}>GAME ID</label>
              ...
              <div>
                <div>
                  <label className="block text-xs font-cinzel tracking-widest mb-1.5" style={{ color: "hsl(var(--brown))", fontFamily: "'ROWAN', serif" }}>DATE & TIME</label>
                  <Popover>
              ...
              <div>
                <label className="block text-xs font-cinzel tracking-widest mb-1.5" style={{ color: "hsl(var(--brown))", fontFamily: "'ROWAN', serif" }}>RULES</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-cinzel tracking-widest mb-1.5" style={{ color: "hsl(var(--brown))", fontFamily: "'ROWAN', serif" }}>GAME IMAGE</label>
                ...
                <div>
                  <label className="block text-xs font-cinzel tracking-widest mb-1.5" style={{ color: "hsl(var(--brown))", fontFamily: "'ROWAN', serif" }}>BG VIDEO</label>
              ...
              {/* Status toggle */}
              <div>
                <label className="block text-xs font-cinzel tracking-widest mb-2" style={{ color: "hsl(var(--brown))", fontFamily: "'ROWAN', serif" }}>STATUS</label>
                <button
              ...
              {form.status === "completed" && (
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="text-xs font-cinzel tracking-widest" style={{ color: "hsl(var(--brown))", fontFamily: "'ROWAN', serif" }}>GAME RANKINGS</label>
                    {rankings.length < 10 && (
                      <button onClick={() => setRankings((r) => [...r, { rank: r.length + 1, player_id: "", points: 0 }])} className="text-xs font-cinzel" style={{ color: "hsl(var(--brown-light))", fontFamily: "'ROWAN', serif" }}>+ Add</button>
                    )}
                  </div>
                ...
                <button onClick={saveGame} disabled={saving} className="w-full py-3 rounded-xl font-cinzel text-sm tracking-widest flex items-center justify-center gap-2" style={{ background: "linear-gradient(135deg, hsl(var(--brown)), hsl(var(--brown-light)))", color: "hsl(var(--cream))", fontFamily: "'ROWAN', serif" }}>
