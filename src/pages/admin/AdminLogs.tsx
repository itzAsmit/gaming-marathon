      ...
      <div className="p-8">
        ...
        {loading ? (
          ...
          <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid hsl(var(--cream-dark))" }}>
            <div className="grid grid-cols-4 gap-4 px-6 py-3 text-xs  tracking-widest" style={{ background: "hsl(var(--input))", color: "hsl(var(--brown))", fontFamily: "Electrolize, sans-serif" }}>
