      ...
      <div className="p-8">
        ...
        {loading ? (
          ...
          <div className="rounded-2xl overflow-hidden" style={{ border: "1px solid hsl(var(--cream-dark))" }}>
            <div className="grid grid-cols-4 gap-4 px-6 py-3 text-xs font-cinzel tracking-widest" style={{ background: "hsl(var(--input))", color: "hsl(var(--brown))", fontFamily: "'ROWAN', serif" }}>
            ...
            {logs.map((log) => {
              ...
              return (
                <div key={log.id} className="grid grid-cols-4 gap-4 px-6 py-3 text-sm border-t" style={{ background: "hsl(var(--card))", borderColor: "hsl(var(--cream-dark))", color: "hsl(var(--brown-deep))" }}>
                  <div className="font-semibold text-xs font-cinzel" style={{ color: "hsl(var(--brown))", fontFamily: "'ROWAN', serif" }}>{log.action}</div>
