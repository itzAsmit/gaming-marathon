    ...
    <AdminLayout>
      <div className="p-4 md:p-8">
        <div className="flex flex-wrap items-center justify-between gap-3 mb-1">
          <h1 className="text-2xl  font-bold" style={{ color: "hsl(var(--brown-deep))", fontFamily: "Electrolize, sans-serif" }}>Assign Items</h1>
          <button
            onClick={loadData}
            disabled={refreshing || saving}
            className="px-3 py-2 rounded-xl text-xs  tracking-wider flex items-center gap-2 disabled:opacity-60"
            style={{ background: "hsl(var(--input))", color: "hsl(var(--brown-deep))", border: "1px solid hsl(var(--cream-dark))", fontFamily: "Electrolize, sans-serif" }}
          >
        ...
        <div className="grid gap-6 lg:grid-cols-[1.15fr_1fr]">
          <div className="rounded-2xl p-4" style={{ background: "hsl(var(--card))", border: "1px solid hsl(var(--cream-dark))" }}>
            <p className="text-xs  tracking-widest mb-3" style={{ color: "hsl(var(--brown))", fontFamily: "Electrolize, sans-serif" }}>PLAYERS & ASSIGNED ITEMS</p>
          ...
          <div className="rounded-2xl p-4" style={{ background: "hsl(var(--card))", border: "1px solid hsl(var(--cream-dark))" }}>
            <p className="text-xs  tracking-widest mb-3" style={{ color: "hsl(var(--brown))", fontFamily: "Electrolize, sans-serif" }}>ITEMS</p>
              ...
              {items.map((item) => {
                ...
                return (
                  <button
                    ...
                    className="px-3 py-2 rounded-xl text-xs  tracking-wider transition-all disabled:opacity-50"
                    style={{
                      background: assigned
            ...
            <p className="text-xs  tracking-widest mb-2" style={{ color: "hsl(var(--brown))", fontFamily: "Electrolize, sans-serif" }}>ASSIGNED TO SELECTED PLAYER</p>
