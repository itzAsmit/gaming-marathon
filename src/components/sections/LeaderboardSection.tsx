...
export default function LeaderboardSection() {
  ...
  const fetchLeaderboard = async () => {
    try {
      ...
      try {
        const fallback = await fetchPublicData<LeaderboardEntry[]>("leaderboard");
        setEntries(fallback ?? []);
      } catch {
  ...
  return (
    <section id="leaderboard" className="relative min-h-[100svh] md:min-h-screen px-4 pt-32 pb-24 md:pt-36 scroll-mt-24 md:scroll-mt-28">
